...
VIDEO_FILE="${VIDEO_DIR}/kubernetes-contexts-e2e.mp4"
RAW_VIDEO_FILE="${VIDEO_DIR}/kubernetes-contexts-e2e.raw.mp4"
SUBTITLES_FILE="${VIDEO_DIR}/kubernetes-contexts-e2e.ass"
CHAPTERS_FILE="${VIDEO_DIR}/kubernetes-contexts-e2e.ffmetadata"
FFMPEG_LOG="${VIDEO_DIR}/kubernetes-contexts-e2e.ffmpeg.log"
